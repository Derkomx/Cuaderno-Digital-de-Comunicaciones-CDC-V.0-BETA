    ...
    <script>
        ...
        $(document).ready(function() {
            $('#anio').on('change', function() {
                ...
                $('#alumno').empty().append(
                    '<option value="todos" selected>Ver de todos</option>'
                );
            ...
            $('#btnEnviar').on('click', function(e) {
                ...
                const actionUrl = `index.php?Seccion=cuaderno32&anio=${cursoSeleccionado}&division=${divisionSeleccionada}&alumno=${alumnoSeleccionado}`;
...
<body>
    ...
    <form id="formulario-escolar" action="index.php?Seccion=cuaderno32" method="post">
