							...
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<tr>
                                    <td align="center" style="padding: 20px;">
                                        <a href="https://cuaderno.cet3.ar/"
                                            style="background-color: #156E12; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-family: Arial, sans-serif; font-size: 16px;">
                                            Ir al Sistema
                                        </a>
                                    </td>
                                </tr>
