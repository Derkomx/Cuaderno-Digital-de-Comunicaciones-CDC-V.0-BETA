...
function Registro() {
    ...
    // Si no seleccionó un rol
    if (rol === "") {
        Incompleto = true;
        document.getElementById("rol").style.borderColor = "LightCoral";
        setTimeout(function() { document.getElementById("rol").style.borderColor = "LightGray"; }, 3000);
        Notiflix.Notify.Failure("Debe seleccionar un rol.");
    }
    ...
    $.ajax({
        type: 'POST',
        url: 'Inyector.php',
        data: { Archivo: 'Registroadm.php', dni: dni, contraseña: contraseña, nombre: nombre, apellido: apellido, rol: rol },
        dataType: 'html',
